...
## Beyond standard: Concentration and Clustering
...
1.  **Temporal deterioration:** 9-point swing, 95% within-segment.
2.  **COMP_N mispricing:** 24 points above benchmark, structurally distinct.
3.  **Bonus-malus paradox:** Neutral runs worse than Bad; rigidity ruled out.
4.  **Geography and age interactions:** wide within-category heterogeneity.
...
**Future research:** causal inference, telematics, longitudinal modelling, external benchmarking, missingness mechanism.
