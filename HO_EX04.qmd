...
#### Extra Alternative 5: plot_ly Animation with Clearer Animation Controls
...
This alternative uses a plotly animated bar chart instead of an animated bubble plot. For each year, it shows the top 10 countries by population. This gives a different visual flow because the focus is now on ranking and comparison, rather than movement across two percentage variables.
